...
# 添加OpenManus路径
sys.path.append('OpenManus-main')
...
try:
    ...
    print(f"OpenManus模块导入失败: {e}")
    print("请确保OpenManus-main目录存在且已正确安装")
    sys.exit(1)
...
class EyeHealthTool(Tool):
    """眼部健康专用工具集"""
    
    name: str = "eye_health_tool"
    description: str = "专门用于眼部健康检测、训练和分析的工具集"
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info("眼部健康工具初始化完成")
        except Exception as e:
            logger.error(f"眼部健康工具初始化失败: {e}")
...
class AdvancedVisionTestTool(EyeHealthTool):
    ...
    name: str = "advanced_vision_test"
    description: str = "进行综合视力检测，包括色觉、对比度、周边视野和眼动追踪"
...
class VisionTrainingTool(EyeHealthTool):
    ...
    name: str = "vision_training"
    description: str = "启动视力训练游戏，包括眼动追踪、专注力、反应速度等训练"
...
class VisionAnalyticsTool(EyeHealthTool):
    ...
    name: str = "vision_analytics"
    description: str = "分析视力数据，生成趋势报告和个性化建议"
...
class EyeHealthConsultationTool(EyeHealthTool):
    ...
    name: str = "eye_health_consultation"
    description: str = "基于症状进行眼部健康咨询，提供专业建议"
...
class EyeHealthAgent(Manus):
    ...
    def __init__(self, **kwargs):
        ...
        self.eye_health_tools = [
            VisionTestTool(),
            AdvancedVisionTestTool(),
            VisionTrainingTool(),
            VisionAnalyticsTool(),
            EyeHealthConsultationTool()
        ]
        
        # 将眼部健康工具添加到可用工具中
        for tool in self.eye_health_tools:
    ...
    async def run_eye_health_task(self, task_description: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 运行任务
            await self.run(task_description)
...
class EyeHealthSystem:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # 创建眼部健康代理
            self.agent = await EyeHealthAgent.create()
    ...
    async def _handle_training_request(self, request: str) -> Dict[str, Any]:
        ...
        await training_tool.initialize()
    ...
    async def _handle_consultation_request(self, request: str) -> Dict[str, Any]:
        ...
        await consultation_tool.initialize()
    ...
    async def _handle_analysis_request(self, request: str) -> Dict[str, Any]:
        ...
        await analytics_tool.initialize()
