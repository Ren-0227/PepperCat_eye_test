...
# from src.openmanus_agent.sandbox_client import SANDBOX_CLIENT  # 如需沙箱可后续补全
from src.openmanus_agent.schema import ROLE_TYPE, AgentState, Memory, Message
...
class BaseAgent(BaseModel, ABC):
    ...
    llm: OllamaChatCompletion = Field(default_factory=OllamaChatCompletion, description="Language model instance")
    ...
    def initialize_agent(self) -> "BaseAgent":
        if self.llm is None or not isinstance(self.llm, OllamaChatCompletion):
            self.llm = OllamaChatCompletion()
